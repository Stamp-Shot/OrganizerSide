...
public class APIJudge : MonoBehaviour {
...
//判定関係
public class CheckJudgeFunction
{
    //1. 元のデータから要らない部分を捨てる
    //2. 上から何個か取る
    //3. 同じ要素があったらtrue
...
public class APIJudgeFunction
{
    ...
    public static EntityAnnotation[] RequestVisionAPI(string base64String)
    {
        ...
        return CheckJudgeFunction.removeAnnotation(buff.responses[0].labelAnnotations.ToArray());
    }
}